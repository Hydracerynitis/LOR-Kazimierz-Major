...
namespace KazimierzMajor
{
    ...
    class MaxLight20HP
    {
        ...
        [HarmonyPrefix]
        public static bool BattleUnitCostUI_Awake(BattleUnitCostUI __instance, bool __runOriginal)
        {
            if (!__runOriginal)
                return false;
            ...
            {
                __instance.costLists.Add(new BattleUnitCostUI.CostBattleUIImage(OB.Instantiate(__instance.prefab_cost, index < 5 || index > 14 ? __instance.upperLine : __instance.lowerLine)));
        ...
        {
            if (__instance.fixedMaxcost < 20 || __instance.costLists == null)
                return true;
