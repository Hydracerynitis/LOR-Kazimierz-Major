...
namespace KazimierzMajor
{
    public class FarAreaEffect_Effect02_Yaoyanghanshou : FarAreaEffect
    {
        ...
        public override void Init(BattleUnitModel self, params object[] args)
        {
            ...
            SingletonBehavior<DiceEffectManager>.Instance.CreateBehaviourEffect("Effect02_Yaoyanghanshou", 1f, this._self.view, BattleFarAreaPlayManager.Instance.attacker.currentDiceAction.target.view);
        }
