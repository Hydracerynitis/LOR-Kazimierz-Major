...
namespace EmotionalFix
{
    public class BattleVoidBehaviour
    {
        ...
        public static void ExtraHit(BattleUnitModel enemy, BattleDiceBehavior dice, int DamageReductionByGuard)
        {
        ...
        public static void ExtraHit(BattleUnitModel enemy, BattleDiceBehavior dice, DiceBehaviour NewBehaviour, int DamageReductionByGuard)
        {
